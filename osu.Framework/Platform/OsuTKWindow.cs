    ...
    public abstract class OsuTKWindow : IWindow, IGameWindow
    {
        ...
        public CursorState CursorState
        {
            ...
            set
            {
                ...
                OsuTKGameWindow.Cursor = cursorState.HasFlagN(CursorState.Hidden) ? MouseCursor.Empty : MouseCursor.Default;

                try
                {
                    OsuTKGameWindow.CursorGrabbed = cursorState.HasFlagN(CursorState.Confined);
                }
                catch
                {
