...
{
    public readonly struct PolygonClipper
    {
        private readonly IPolygon clipPolygon;
        private readonly IPolygon subjectPolygon;

        public PolygonClipper(IPolygon clipPolygon, IPolygon subjectPolygon)
        {
        ...
        {
            // Assume the two polygons are non-convex, requiring at most n*m intersection points.
