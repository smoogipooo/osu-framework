...
namespace osu.Framework.Graphics
{
    ...
    {
        public static TransformSequence<T> TransformTo<T, TValue, TEasing>(this TransformSequence<T> t, string propertyOrFieldName, TValue newValue, double duration = 0, TEasing easing = default)
            where T : Drawable
