...
namespace osu.Framework.Graphics.Containers.Markdown
{
    ...
    public class MarkdownTable : CompositeDrawable
    {
        ...
        private readonly LayoutCached columnDefinitionCache = new LayoutCached(Invalidation.DrawSize);
        private readonly LayoutCached rowDefinitionCache = new LayoutCached(Invalidation.DrawSize);
        ...
        public MarkdownTable(Table table)
        {
            ...
            Layout.AddDependency(columnDefinitionCache);
            Layout.AddDependency(rowDefinitionCache);
        }
