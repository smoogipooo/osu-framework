...
namespace osu.Framework.Graphics.Transforms
{
    ...
    /// <typeparam name="TEasing">The type of easing of the.</typeparam>
        ...
        where TEasing : IEasingFunction
    {
        ...
        /// picked for interpolating between <see cref="Transform{TValue,TEasing}.StartValue"/> and
        /// <see cref="Transform{TValue,TEasing}.EndValue"/> according to <see cref="Transform.StartTime"/>,
        ...
        /// The function to be used for interpolating between <see cref="Transform{TValue,TEasing}.StartValue"/> and
        /// <see cref="Transform{TValue,TEasing}.EndValue"/> according to <see cref="Transform.StartTime"/>,
        /// <see cref="Transform.EndTime"/>, and a current time.
        ...
        /// </param>
        public TransformCustom(string propertyOrFieldName, InterpolationFunc<TValue, TEasing> interpolationFunc = null)
        {
            ...
            this.interpolationFunc = interpolationFunc ?? InterpolationCache<TValue, TEasing>.FUNCTION;
    ...
    internal class TransformCustom<TValue, T> : TransformCustom<TValue, DefaultEasingFunction, T> where T : class, ITransformable
    {
        public TransformCustom(string propertyOrFieldName, InterpolationFunc<TValue, DefaultEasingFunction> interpolationFunc = null)
            : base(propertyOrFieldName, interpolationFunc)
        {
        }
    }
}
