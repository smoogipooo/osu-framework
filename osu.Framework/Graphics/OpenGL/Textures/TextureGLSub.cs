...
namespace osu.Framework.Graphics.OpenGL.Textures
{
    internal class TextureGLSub : TextureGL
    {
        ...
        public override void DrawTriangle(Triangle vertexTriangle, int depthIndex, RectangleF? textureRect, ColourInfo drawColour, Action<TexturedVertex2D> vertexAction = null, Vector2? inflationPercentage = null)
        {
            parent.DrawTriangle(vertexTriangle, depthIndex, boundsInParent(textureRect), drawColour, vertexAction, inflationPercentage);
        }

        public override void DrawQuad(Quad vertexQuad, int depthIndex, RectangleF? textureRect, ColourInfo drawColour, Action<TexturedVertex2D> vertexAction = null, Vector2? inflationPercentage = null, Vector2? blendRangeOverride = null)
        {
            parent.DrawQuad(vertexQuad, depthIndex, boundsInParent(textureRect), drawColour, vertexAction, inflationPercentage, blendRangeOverride);
        }
