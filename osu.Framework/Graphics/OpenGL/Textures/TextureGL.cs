...
namespace osu.Framework.Graphics.OpenGL.Textures
{
    public abstract class TextureGL : IDisposable
    {
        ...
        /// </summary>
        public abstract void DrawTriangle(Triangle vertexTriangle, int depthIndex, RectangleF? textureRect, ColourInfo drawColour, Action<TexturedVertex2D> vertexAction = null, Vector2? inflationPercentage = null);

        /// <summary>
        /// Blit a quad to OpenGL display with specified parameters.
        /// </summary>
        public abstract void DrawQuad(Quad vertexQuad, int depthIndex, RectangleF? textureRect, ColourInfo drawColour, Action<TexturedVertex2D> vertexAction = null, Vector2? inflationPercentage = null, Vector2? blendRangeOverride = null);
