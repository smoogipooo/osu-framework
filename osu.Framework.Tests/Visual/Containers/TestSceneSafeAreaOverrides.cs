...
namespace osu.Framework.Tests.Visual.Containers
{
    public class TestSceneSafeAreaOverrides : FrameworkTestScene
    {
        ...
        {
            bool leftOverridden = container.SafeAreaContainer.SafeAreaOverrideEdges.HasFlagN(Edges.Left);
            bool topOverridden = container.SafeAreaContainer.SafeAreaOverrideEdges.HasFlagN(Edges.Top);
            bool rightOverridden = container.SafeAreaContainer.SafeAreaOverrideEdges.HasFlagN(Edges.Right);
            bool bottomOverridden = container.SafeAreaContainer.SafeAreaOverrideEdges.HasFlagN(Edges.Bottom);
