            ...
            AddStep("init", () =>
            {
                Child = new Container
                {
                    ...
                    Child = box = new Box
                    {
                        ...
                        Origin = anchor,
                        Size = new Vector2(10),
                        Position = new Vector2(anchor.HasFlagN(Anchor.x0) ? -5 : 5, anchor.HasFlagN(Anchor.y0) ? -5 : 5),
                    }
                };
            });
            ...
            AddStep("init", () =>
            {
                Child = new Container
                {
                    ...
                    Child = box = new Box
                    {
                        ...
                        Origin = anchor,
                        Size = new Vector2(10),
                        Position = new Vector2(anchor.HasFlagN(Anchor.x0) ? -20 : 20, anchor.HasFlagN(Anchor.y0) ? -20 : 20),
                    }
                };
            });
